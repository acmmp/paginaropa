      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300">FashionHub is your one-stop destination for trendy and stylish clothing. We offer a wide range of high-quality apparel for men and women.</p>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-300">&copy; 2024 FashionHub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
